...
CREATE TABLE "TB_ALLOC" ( "SL_ID" INTEGER NOT NULL  , "RSP_ID" INTEGER NOT NULL  , "ALL_SCHEDSTART" DATETIME NOT NULL  , "ALL_SCHEDEND" DATETIME NOT NULL  , "ALL_AMOUNT" DOUBLE NOT NULL  , "ALL_MOVEABLE" BOOL NOT NULL  , "ALL_DURATION" INTEGER , "ALL_DEADLINE" DATETIME , "ALL_STATUS" SMALLINT NOT NULL, "ALL_NEXTSTART" DATETIME, PRIMARY KEY ( "SL_ID" , "RSP_ID" , "ALL_SCHEDSTART" ) );
